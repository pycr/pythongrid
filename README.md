...
Find the sample database in **sample** folder named `sampledb.sql`. Using your favorite MySQL client such as [MySQL Workbench](https://dev.mysql.com/downloads/workbench/), Ccreate a new database named `sampledb` and run the sample sql script.
